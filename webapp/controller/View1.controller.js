    ...
    function (Controller, DateFormat) {
      ...
      return Controller.extend("project1.controller.View1", {
        ...
        formatDate: function (value) {
          // Formatter function to format the date value
          if (value) {
        ...
        formatBaggageAllowance: function (value) {
          // Formatter function to format the baggage allowance value
          if (value) {
        ...
        formatFlightDuration: function (value) {
          // Formatter function to format the flight duration value
          if (value) {
        ...
        formatTime: function (value) {
          // Formatter function to format the time value
          if (value) {
        ...
        formatCityName: (value) => {
          // Formatter function to format the city name value
          if (value) {
